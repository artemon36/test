...
<head>
    ...
    <title>Корзина - Набойки-Мужские (Комбинированные)</title>
    <meta name="description" content="">
    <meta name="h1" content="Ваш заказ">
    <meta name="breadcrumbs" content="Корзина/Набойки-Мужские (Комбинированные)">
    ...
    <script data-n-head="ssr">
        ...
        window.dataLayer.push({
            ...
            pageType: "cart",
            userID: "",
            breadCrumbs: "Корзина/Набойки-Мужские (Комбинированные)",
            categoryId: "",
            categoryName: "",
                                ...
                                <div class="mando-modern-basket__body">
                                            ...
                                            <div data-test="basket-products-single-product"
                                                ...
                                                <div data-test="single-product" class="mando-single-product">
                                                    <div class="mando-single-product__inner"><button
                                                        ...
                                                        <!---->
                                                        <div data-test="single-product-picture" alt="Набойки-Мужские (Комбинированные)"
                                    ...
                                    <div class="mando-modern-basket__sidebar">
                                        ...
                                        <div data-test="basket-order"
                                            ...
                                            <div class="mando-modern-order__inner">
                                                ...
                                                <div class="mando-modern-order__item">
                                                    ...
                                                    <div class=""><span data-test="basket-order-products-price"
                                                            class="mando-modern-order__value">2,990&nbsp;₽</span>
                                                    </div>
                                                </div>
                                                <!---->
                                                <!---->
                                            ...
                                            <input name="slots" type="hidden" value="Набойки-Мужские (Комбинированные)" style="position: absolute"/>
