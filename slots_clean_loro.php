...
<head>
    ...
    <title>Корзина - Чистка Loro Piano</title>
    <meta name="description" content="">
    <meta name="h1" content="Ваш заказ">
    <meta name="breadcrumbs" content="Корзина/Чистка Loro Piano">
    ...
    <script data-n-head="ssr">
        ...
        window.dataLayer.push({
            ...
            pageType: "cart",
            userID: "",
            breadCrumbs: "Корзина/Чистка Loro Piano",
            categoryId: "",
            categoryName: "",
                                ...
                                <div class="mando-modern-basket__body">
                                            ...
                                            <div data-test="basket-products-single-product"
                                                ...
                                                <div data-test="single-product" class="mando-single-product">
                                                    <div class="mando-single-product__inner"><button
                                                        ...
                                                        <!---->
                                                        <div data-test="single-product-picture" alt="Чистка Loro Piano"
                                    ...
                                    <div class="mando-modern-basket__sidebar">
                                        ...
                                        <div data-test="basket-order"
                                            ...
                                            <input name="slots" type="hidden" value="Чистка Loro Piano" style="position: absolute"/>
