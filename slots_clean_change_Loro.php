...
<head>
    ...
    <title>Корзина - Чистка и замена подошвы Loro Piano</title>
    <meta name="description" content="">
    <meta name="h1" content="Ваш заказ">
    <meta name="breadcrumbs" content="Корзина/Чистка и замена подошвы Loro Piano">
    ...
    <script data-n-head="ssr">
        ...
        window.dataLayer.push({
            ...
            pageType: "cart",
            userID: "",
            breadCrumbs: "Корзина/Чистка и замена подошвы Loro Piano",
            categoryId: "",
            categoryName: "",
                                ...
                                <div class="mando-modern-basket__body">
                                            ...
                                            <div data-test="basket-products-single-product"
                                                ...
                                                <div data-test="single-product" class="mando-single-product">
                                                    <div class="mando-single-product__inner"><button
                                                        ...
                                                        <!---->
                                                        <div data-test="single-product-picture" alt="Чистка и замена подошвы Loro Piano"
                                                            ...
                                                            <!---->
                                                            Чистка и замена подошвы Loro Piano
                                                            <!---->
                                                        </a>
                                                        <div class="mando-single-product__additional"><span
                                                                data-test="single-product-price"
                                                                class="mando-single-product__price">23,990&nbsp;₽</span>
                                                            <!---->
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="mando-modern-basket__sidebar">
                                        ...
                                        <div data-test="basket-order"
                                            ...
                                            <div class="mando-modern-order__inner">
                                                ...
                                                <div class="mando-modern-order__item">
                                                    ...
                                                    <div class=""><span data-test="basket-order-products-price"
                                                            class="mando-modern-order__value">23,990&nbsp;₽</span>
                                                    </div>
                                                </div>
                                                <!---->
                                                <!---->
                                            ...
                                            <input name="slots" type="hidden" value="Чистка и замена подошвы Loro Piano" style="position: absolute"/>
